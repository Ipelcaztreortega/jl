...
public class NextMoviePoly {
    public static void main(String[] args) {
        ...
        // Creating a variable with Fundamentals.Polymorphism.Movie type, and assigning the result of this static call
        Movie movie = Movie.getMovie("A", "Jaws");
        movie.watchMovie();

        // You can cast instances as well, when can you assign an object of one type to a reference of a different type
//        Fundamentals.Polymorphism.Adventure jaws = (Fundamentals.Polymorphism.Adventure) Fundamentals.Polymorphism.Movie.getMovie("C", "Jaws");
//        jaws.watchMovie();
        ...
        if (unknownObject.getClass().getSimpleName() == "Fundamentals.Polymorphism.Comedy") {
